...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    image: "/images/Framed Narrative.webp",
  ...
  },
  {
    ...
    image: "/images/The Unasked Arrival.webp",
    orientation: "PORTRAIT",
  ...
  },
  {
    ...
    size: "50 x 50 cm",
    description:"",
    image: "/images/Ethiopian coffee ceremony.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
  ...
  },
  {
    ...
    image: "/images/Flawed Beauty.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Inner States",
    status: "Available",
  ...
  },
  {
    ...
    image: "/images/Holding the Left Ones.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Inner States",
    status: "Available",
  ...
  },
  {
    ...
    image: "/images/10  Title untitled.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Geometry of Memory",
    status: "Available",
  ...
  },
  {
    ...
    size: "30 x 100 cm",
    description:"",
    image: "/images/13  title untitled.webp",
    orientation: "LANDSCAPE",
    category: "Landscapes",
    collection: "Ethiopian Reverie",
    status: "Available",
  ...
  },
  {
    ...
    size: "70 x 120 cm",
    description:
      "A visceral exploration of the contrast between the external shell and the internal essence. The composition is framed by a dark, fractured boundary reminiscent of cooling volcanic rock or parched earth which yields to a radiant, liquid interior. At the center, a silhouetted figure cradles a glowing, golden orb, suggesting a hidden source of warmth and vitality protected by a harsh exterior. By leaving this work untitled, the artist invites the viewer to step into the void and find their own meaning within the balance of shadow and light.",
    image: "/images/14.Untitled.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Inner States",
    status: "Available",
  ...
  },
  {
    ...
    size: "Dimensions Variable",
    description:
      "This mixed media piece examines the psychological 'stuckness' of the human condition. It portrays the tragedy of those who define themselves so deeply through their struggle that they cannot survive the peace that follows. Like a retired worker who passes away shortly after leaving their post, the figure here is a ghost of effort, still physically connected to a mechanism that no longer moves. It is a study of memory and penance, an acknowledgment that while others may forgive us, the internal 'hinge' of our own actions often keeps us trapped in the past.",
    image: "/images/Hinged to the Ghost.webp",
    orientation: "LANDSCAPE",
    category: "Landscapes",
    collection: "Mixed Reflections",
    status: "Available",
  ...
  },
  {
    ...
    image: "/images/Vertical Silence.webp",
    orientation: "LANDSCAPE",
    category: "Landscapes",
    collection: "Ethiopian Reverie",
    status: "Sold",
  ...
  },
  {
    ...
    size: "52 x 92 cm",
    description:"",
    image: "/images/18  title untitled.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Geometry of Memory",
    status: "Available",
  ...
  },
  {
    ...
    size: "Dimensions Variable",
    description:
      "An exploration of reverse deja vu, the experience of daily reality manifesting within the dream state, rather than a dream predicting the future.",
    image: "/images/Dream and Daily Routine.webp",
    orientation: "LANDSCAPE",
    category: "Landscapes",
    collection: "Mixed Reflections",
    status: "Available",
  ...
  },
  {
    ...
    size: "80 x 165 cm",
    description:
      "This work is born from a single day spent in confinement, an experience that revealed a heartbreaking cycle of hope and disillusionment. I watched as prisoners crowded toward tiny windows, desperate for a glimpse of 'the outside.' But when I stood where they stood, I saw no horizon only another wall, another barred door, a 'cell within a cell.' Yearning is a meditation on that moment of profound realization. It asks a haunting question about the nature of the captive mind: When we look out from our darkest places, are we truly seeing the world as it is? Or are we merely projecting the 'leftover shadows' of our own lives onto the void, searching for a version of ourselves that we left behind?",
    image: "/images/Yearning.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Inner States",
    status: "Available",
  ...
  },
  {
    ...
    image: "/images/Choosing.webp",
    orientation: "PORTRAIT",
    category: "Mixed Media",
    collection: "Mixed Reflections",
    status: "Available",
    price: "$100 USD",
    secondaryImages: ["/images/Choosing2.webp"],
    printEdition: "10 prints",
  },
  {
    ...
    size: "",
    description: 
      "A monumental study of the illusion of choice and the weight of psychological entanglement. Spanning over two meters, this work portrays a central figure paralyzed by the very options it seeks to balance. While the world offers us a 'bilateral' path represented by the sharp contrast of green and yellow the artist suggests that these choices are a form of 'destruction.' The figure does not choose; it merely carries, clutching two heavy, differing identities like burdens. It is a visceral critique of the modern condition, where the abundance of paths leads not to freedom, but to a fragmented self, caught in a repetitive grid of systemic noise.",
    image: "/images/The Carrying Mind.webp",
    orientation: "PORTRAIT",
    category: "Portraits",
    collection: "Inner States",
    status: "Available",
